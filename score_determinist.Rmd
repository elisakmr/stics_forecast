...
---
The code aims at computing deterministic scores, being Anomaly Correlation Coefficient, and Root Mean Square Error, for ps and climato.
...
registerDoParallel(cl) # parallelizing on them
  ...
  foreach(b=1:nboot, .packages=c('easyVerification', 's2dverification')) %dopar%  { # for-loop parallelized
    ...
    nom_an_clim <- paste0(indicateur,b,"_anomaly_clim_uerra5.RData")
